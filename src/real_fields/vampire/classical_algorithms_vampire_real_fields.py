from src.real_fields.base_classes_methods import RetrievePulsesVAMPIREwithRealFields
from src.real_fields.frog import (GeneralizedProjection as GeneralizedProjectionFROG,
