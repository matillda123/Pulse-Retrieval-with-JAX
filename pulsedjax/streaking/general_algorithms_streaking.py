...
class DifferentialEvolution(DifferentialEvolutionBASESTREAKING, RetrievePulsesSTREAKING):
    ...
    def __init__(self, delay_fs, energy_eV, measured_trace, Ip_eV=0, retrieve_dtme=False, cross_correlation=True, interferometric=False, 
...
class Evosax(EvosaxBASESTREAKING, RetrievePulsesSTREAKING):
    ...
    def __init__(self, delay_fs, energy_eV, measured_trace, Ip_eV=0, retrieve_dtme=False, cross_correlation=True, interferometric=False, solver=None, **kwargs):
