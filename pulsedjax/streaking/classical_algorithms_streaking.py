...
from pulsedjax.core.base_classic_algorithms import GeneralizedProjectionBASE, normalize_population
...
class GeneralizedProjection(GeneralizedProjectionBASE, RetrievePulsesSTREAKING):
