...
def calculate_Z_gradient(signal_t, signal_t_new, pulse_t, gate_pulses, gate, tau_arr, measurement_info, pulse_or_gate, is_vampire=True):
    """
    ...
    return calculate_Z_gradient_2DSI(signal_t, signal_t_new, pulse_t, gate_pulses, gate, tau_arr, measurement_info, pulse_or_gate, is_vampire=is_vampire)