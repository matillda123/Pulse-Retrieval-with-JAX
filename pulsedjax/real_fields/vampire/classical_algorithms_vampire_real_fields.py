...
from pulsedjax.vampire import (LSGPA as _LSGPA, CPCGPA as _CPCGPA,
...
class LSGPA(RetrievePulsesVAMPIREwithRealFields, _LSGPA):
...
class CPCGPA(RetrievePulsesVAMPIREwithRealFields, _CPCGPA):
    __doc__ = _CPCGPA.__doc__

    def __init__(self, delay, frequency, trace, nonlinear_method, tau_interferometer=0,
                 material_thickness=0, refractive_index=refractiveindex.RefractiveIndexMaterial(shelf="main", book="SiO2", page="Malitson"), 
                 cross_correlation=False, constraints=False, svd=False, antialias=False, **kwargs):
        super().__init__(delay, frequency, trace, nonlinear_method, tau_interferometer=tau_interferometer, 
                         material_thickness=material_thickness, refractive_index=refractive_index, 
...
class GeneralizedProjection(RetrievePulsesVAMPIREwithRealFields, _GeneralizedProjection):
...
class PtychographicIterativeEngine(RetrievePulsesVAMPIREwithRealFields, _PtychographicIterativeEngine):
...
class COPRA(RetrievePulsesVAMPIREwithRealFields, _COPRA):
...
class LSF(RetrievePulsesVAMPIREwithRealFields, _LSF):
